# Lifecycle — sap-investigator

Lifecycle tracking for the `sap-investigator` agent (co-abap variant).

| Field | Value |
|-------|-------|
| Agent file | [`agents/sap-investigator.md`](../../../agents/sap-investigator.md) |
