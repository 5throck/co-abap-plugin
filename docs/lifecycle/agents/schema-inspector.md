# Lifecycle — schema-inspector

Lifecycle tracking for the `schema-inspector` agent (co-abap variant).

| Field | Value |
|-------|-------|
| Agent file | [`agents/schema-inspector.md`](../../../agents/schema-inspector.md) |
