...
|---|-----------|--------|-----------------|
| 1 | **Phase A complete** | Done | `phaseAComplete` in variant.json; agent manifest (20), skill manifest (13), documentation present. |
| 2 | **Agent roster completeness** | Pending | All 20 agents defined; verify each agent file has substantive content. |
| 3 | **Skills coverage** | Pending | 13 variant-specific skills; verify each SKILL.md is complete and operational. |
